...
public class Observer implements IObserver {
     ...
     */
    public Observer(ICommand notify, Object context) {
    ...
    public void notifyObserver(INotification notification) {
        getNotifyMethod().execute(notification);
    }
     ...
     */
    public void setNotifyMethod(ICommand notifyMethod) {
        notify = notifyMethod;
    }
     ...
     */
    public ICommand getNotifyMethod() {
        return notify;
    }
